...
<html lang="ko">
  <head>
    <meta charset="utf-8" />
    <title>{title} > 마포구</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta
      content="{no_keywords}, 마포구하수구막힘, 마포구변기막힘, 마포구싱크대막힘"
      name="keywords"
    />
    <meta
    ...
    <link rel="canonical" href="https://jianhomecare.com/마포구/{no_keywords}" />
    ...
    <meta
      ...
      content="{keywords} 바로 해결해드립니다. 하수구막힘,싱크대막힘,변기뚫음,변기수리,변기역류,변기교체까지 완-벽하게!"
    />
    <meta property="og:url" content="https://jianhomecare.com/마포구/{no_keywords}" />
    ...
    <meta property="og:image:alt" content="마포구변기막힘" />
    <meta property="og:image:type" content="image/gif" />
    <meta name="twitter:domain" content="{keywords}">
    
    <meta property="article:section" content="마포구변기막힘">
    ...
    <meta property="article:published_time" content="2025-08-05T09:11:00+09:00" />
    <meta property="article:modified_time" content="2025-08-06T10:30:00+09:00" />
    ...
    <script type="application/ld+json">
      {{
        ...
        "image": "https://jianhomecare.com/temp_images/{image_url}",
        "publisher": {{
          "@type": "Organization",
          "name": "지안홈케어",
          "logo": {{
            "@type": "ImageObject",
            "url": "https://jianhomecare.com/img/logo.png"
          }}
        }}
      }}
    </script>
    ...
    {{
      ...
      "mainEntity": [
        {{
          ...
          "acceptedAnswer": {{
            "@type": "Answer",
            "text": "마포구 전문 하수구업체 📞010-3463-4474📞"
          }}
        }},
        {{
          "@type": "Question",
          "name": "마포구 하수구 막힘 24시 가능한가요?",
          "acceptedAnswer": {{
            "@type": "Answer",
            "text": "네, 마포구 외 서울 전 지역 24시 작업 가능하오니 언제든지 📞010-3463-4474📞으로 편하게 문의주세요😊"
          }}
        }},
        {{
          "@type": "Question",
        ...
        {{
          ...
          "acceptedAnswer": {{
            "@type": "Answer",
            "text": "기름은 절대 싱크대에 버리지 말고, 배수구에는 거름망을 설치해 이물질 유입을 줄이세요. 정기적인 뜨거운 물 세척도 도움이 됩니다."
          }}
        }}
      ]
    }}
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        <a href="/" class="navbar-brand font-weight-bold text-secondary">
          <span class="text-primary">마포구변기막힘</span>
        </a>
        <button
          type="button"
    ...
    <div class="container py-5">
      <div class="row pt-5">
        <div class="col-lg-8">
          ...
          <div class="mb-5 d-flex flex-column">
            ...
            <div class="toc">
              ...
              <ul>
                  ...
                  <li><a href="#section2">2. 마포구하수구막힘</a></li>
                  <li><a href="#section3">3. 마포구변기막힘 </a></li>
          ...
          />
            ...
            <h2 class="mb-4" id="section2" style="text-align: center;">마포구하수구막힘</h2>
            <img
            ...
            <h2 class="mb-4" id="section3" style="text-align: center;">마포구변기막힘</h2>
            <img
      ...
      <div class="container p-0">
        <div class="text-center pb-2">
          ...
          <h2>FAQ</h2>
          <h2>{title}</h2>
          <p>마포구 전문 하수구업체 📞010-3463-4474📞</p>
          <br>
          <h2>마포구 하수구막힘 24시 가능한가요?</h2>
          <p>네, 마포구 외 서울 전 지역 24시 작업 가능하오니 언제든지 📞010-3463-4474📞으로 편하게 문의주세요😊</p>
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          ...
          <div class="mb-5">
            ...
            <div class="d-flex flex-wrap m-n1">
              ...
              <a href="https://jianhomecare.com/yangcheon-toilet/" class="btn btn-outline-primary m-1">양천구변기막힘</a>
              <a href="https://jianhomecare.com/마포구" class="btn btn-outline-primary m-1">마포구변기막힘</a>
            </div>
          </div>
   ...
   <a href="tel:010-3463-4474" class="back-to-top"
    ><img src="../img/call.png" width="80px" alt="마포구 변기막힘 상담"></a>
...
# 엑셀 파일에서 데이터를 읽어옴
keywords, column2_values, column3_values = read_keywords_from_excel("마포구.xlsx")
...
def process_keywords(keywords, column2_values, column3_values):
    ...
    for keyword_string in keywords:
        ...
        html_content = html_template.format(
            ...
            # sep_keyword0 = no_keyword_str['Keyword'].replace(" ", "")
